...
def vp_start_gui():
    ...
    root = Tk()
    top = Toplevel (root)
    baselogin_support.init(root, top)
    root.mainloop()
...
def create_Toplevel(root, *args, **kwargs):
    ...
    w = Toplevel (root)
    top = Toplevel (w)
    baselogin_support.init(w, top, *args, **kwargs)
    return (w, top)
...
class Toplevel:
    def __init__(self, top=None):
        ...
        self.menubar.add_command(
                ...
                background="#d9d9d9",
                command=baselogin_support.TODO,
                foreground="#000000",
                label="NewCommand")


        self.Frame3 = Frame(top)
        self.Frame3.place(relx=0.09, rely=0.07, relheight=0.76, relwidth=0.82)
        ...
        self.Entryschool.configure(selectbackground="#c4c4c4")
